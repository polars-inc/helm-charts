...
*/}}
{{- define "polars-k8s-operator.name" -}}
...
*/}}
{{- define "polars-k8s-operator.fullname" -}}
...
*/}}
{{- define "polars-k8s-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "polars-k8s-operator.resourceName" -}}
{{- $fullname := include "polars-k8s-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "polars-k8s-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "polars-k8s-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
