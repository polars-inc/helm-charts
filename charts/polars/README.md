...
| anonymousResults.temporaryStorage | object | `{"enabled":false,"presignEndpointUrl":"http://localhost:8333"}` | Configure using quick-start seaweedfs |
| anonymousResults.temporaryStorage.enabled | bool | `false` | Enable seaweedfs S3 storage for anonymous results. This will deploy a seaweedfs mini deployment. |
